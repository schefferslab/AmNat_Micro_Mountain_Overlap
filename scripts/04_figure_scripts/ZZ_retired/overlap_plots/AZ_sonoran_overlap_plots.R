...
# Import data
data_raw <- read_csv("data/01_primary/temperate/AZ_sonoran_desert/derivative/AZ_sonoran_desert_wide.csv")

# Designate site name
SITE_NAME <- "Sonoran Desert (Arizona)"

# Designate elevations of low and high sites
LOW_ELEVATION <- "275"
HIGH_ELEVATION <- "1280"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "figures/overlap_figures/AZ_2011.png"
