  ...
  # Import data
  data_raw <- read_csv("data/01_primary/temperate/TN_coweeta/derivative/TN_coweeta_soil_205_SM3_D5_wide.csv")
  
  # Designate site name
  SITE_NAME <- "Tennessee Coweeta LTER"
  
  # Designate elevations of low and high sites
  LOW_ELEVATION <- "735.3"
  HIGH_ELEVATION <- "UK"
  # Set file path where figure will be saved
  OUTPUT_FILE_PATH <- "./figures/overlap_figures/TN_soil_205_SM3_D5_2016.png"
