...
# Import data
data_raw <- read.csv("./data/01_primary/temperate/CA_angelo/derivative/Angelo_treebeard_wide.csv")

# Designate site name
SITE_NAME <- "CA Angelo Reserve, mixed deciduous-coniferous forest"

# Designate elevations of low and mid sites
LOW_ELEVATION <- "493.88"
HIGH_ELEVATION <- "1249.31"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/overlap_figures/avg_across_timeseries/Angelo_treebeard_2011.png"
