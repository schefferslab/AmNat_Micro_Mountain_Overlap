...
# Import data
data_raw <- read_csv("data/01_primary/tropical/Madagascar/derivative/Mada_wide.csv")
...
OUTPUT_FILE_PATH <- "figures/overlap_figures/single_year_only/Mada_overlap_2015.png"
...
plot(soil_data$julian, soil_data$low_soil_max, type='n', 
     bty="n", cex.axis=1.5, ylim=c(-20, 50), xlim=c(0,51), ylab='temperature (C)', 
     xlab='Julian Day')
...
plot(canopy_data$julian, canopy_data$low_canopy_max, axes=FALSE, type='n', bty="n", 
     cex.axis=1.5,ylim=c(-20,50), xlim=c(0,51), ylab="", xlab='Julian Day')
