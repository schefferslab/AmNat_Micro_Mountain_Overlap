# David Klinges
# This script generates overlap plots for the White Mountains forested sites

## Workspace prep ##############
library(tidyverse)

# Import data
off <- read_csv("data/01_primary/temperate/NH_whites/derivative/NH_hubbardOff_wide.csv")
on <- read_csv("data/01_primary/temperate/NH_whites/derivative/NH_hubbardOn_wide.csv")
...
# Create figure axes
plot(data$julian, data$low_soil_max, axes=FALSE, type='n', bty="n", 
...
segments(138,-10, 138, 40, lty=2)
segments(289,-10, 289, 40, lty=2)
