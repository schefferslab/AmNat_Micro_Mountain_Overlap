...
# Import data
data_raw <- read_csv("data/01_primary/tropical/Colombia/derivative/CO_pf_wide.csv")

# Designate site name
SITE_NAME <- "Colombia Pamala sites"

# Designate elevations of low and mid sites
LOW_ELEVATION <- "1315"
HIGH_ELEVATION <- "2357"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "figures/overlap_figures/single_year_only/CO_pam/CO__pf_2014.png"
