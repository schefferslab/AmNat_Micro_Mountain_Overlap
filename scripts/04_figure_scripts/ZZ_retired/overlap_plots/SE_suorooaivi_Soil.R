...
# Import data
data_raw <- read_csv("data/01_primary/arctic/SE_suorooaivi/derivative/SE_suorooaivi_SM_wide.csv")

# Designate site name
SITE_NAME <- "Sweden Suorooaivi Mountain"

# Designate elevations of low and high sites
LOW_ELEVATION <- "400"
HIGH_ELEVATION <- "900"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/overlap_figures/SE_SM_2007.png"
...
# Create figure axes
plot(data$julian, data$low_soil_max, axes=TRUE, type='n', bty="n", 
