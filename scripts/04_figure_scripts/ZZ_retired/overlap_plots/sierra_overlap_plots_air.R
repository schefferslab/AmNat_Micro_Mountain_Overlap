...
# Import data
data_raw <- read.csv("./data/02_derivative/sierra_all_elev_all_years_wide.csv")
...
OUTPUT_FILE_PATH <- "./figures/CA_sierra_seasonal_variance_figure_2016_air.png"
...
data <- data %>%
  select(-contains("mid"), -contains("soil"), -contains("ground"))
