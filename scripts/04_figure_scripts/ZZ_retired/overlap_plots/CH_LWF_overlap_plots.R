...
# Import data
data_raw <- read_csv("data/01_primary/temperate/CH_LWF/derivative/open/CH_LWF_VOF_NAF_wide.csv")

# Designate site name
SITE_NAME <- "Switzerland Non-forest Forest"

# Designate elevations of low and high sites
LOW_ELEVATION <- "488.0"
HIGH_ELEVATION <- "1920.0"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/overlap_figures/CH_open_2016.png"
