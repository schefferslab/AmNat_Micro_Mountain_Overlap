...
# Import data
data_raw <- read.csv("./data/01_primary/temperate/PT_serra_estrala/derivative/SerraEstrala_cantaro_zezere_wide.csv")

# Designate site name
SITE_NAME <- "Portugal Serra Estral Mountain, bare"

# Designate elevations of low and mid sites
LOW_ELEVATION <- "1100"
HIGH_ELEVATION <- "1900"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/overlap_figures/avg_across_timeseries/SerraEstrala_cantaro_zezere_2000.png"
