...
# Import data
data_raw <- read.csv("./data/02_derivative/socal_all_elev_avg_years_wide.csv")

# Designate site name
SITE_NAME <- "Wyoming sage brush (open air)"

# Designate elevations of low and high sites
LOW_ELEVATION <- "275"
HIGH_ELEVATION <- "1280"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/socal_seasonal_variance_figure_avg_years.png"
