...
# Import data
data_raw <- read_csv("data/01_primary/temperate/ID_sage_brush/derivative/ID_wide.csv")

# Designate site name
SITE_NAME <- "Wyoming sage brush (open surface)"

# Designate elevations of low and high sites
LOW_ELEVATION <- "275"
HIGH_ELEVATION <- "1280"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/overlap_figures/ID_2017.png"
