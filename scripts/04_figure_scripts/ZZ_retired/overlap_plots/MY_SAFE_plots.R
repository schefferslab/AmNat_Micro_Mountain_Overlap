...
# Import data
data_raw <- read_csv("data/01_primary/tropical/Senior_global/MY_SAFE/derivative/MY_SAFE_wide.csv")

# Designate site name
SITE_NAME <- "Malaysia SAFE project"

# Designate elevations of low and high sites
LOW_ELEVATION <- "297"
HIGH_ELEVATION <- "406"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "figures/overlap_figures/MY_SAFE_2014.png"
