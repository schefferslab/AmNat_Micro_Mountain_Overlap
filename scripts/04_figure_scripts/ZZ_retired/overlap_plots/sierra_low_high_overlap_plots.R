...
# Import data
data_raw <- read_csv("./data/01_primary/temperate/CA_sierra/derivative/low_to_high/Sierra_avgyears_wide.csv")
...
OUTPUT_FILE_PATH <- "./figures/CA_sierra_low_to_high_allyears.png"
