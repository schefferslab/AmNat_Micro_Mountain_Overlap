...
# Import data
data_raw <- read_csv("./data/01_primary/temperate/CA_sierra/derivative/mid_to_high/Sierra_avgyears_wide.csv")
...
OUTPUT_FILE_PATH <- "./figures/CA_sierra_mid_to_high_allyears.png"
...
#   it has no soil or surface data...and so the na.omit will remove everything
