...
# Import data
data_raw <- read.csv("./data/02_derivative/Catalina_avgyears_wide.csv")

# Designate site name
SITE_NAME <- "Catalina Mountains, granite-based desert and coniferous summit"

# Designate elevations of low and mid sites
LOW_ELEVATION <- "1000"
HIGH_ELEVATION <- "2534"
# Set file path where figure will be saved
OUTPUT_FILE_PATH <- "./figures/Catalina_granite_seasonal_variance_figure_avgyears.png"
